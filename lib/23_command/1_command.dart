...
class TurnOffCommand extends Command {
  ...
  TurnOffCommand(Light light, this.name) : super(light, name);
  void execute() {
...
class TurnOnCommand extends Command {
  String name = "Turn on";
  TurnOnCommand(Light light, this.name) : super(light, name);
  void execute() {
...
class LightSwitch {
  ...
  void perform(String action) {
    ...
    switch (action) {
      case "on":
        return _switch.execute(TurnOnCommand(light, "Turn on"));
      case "off":
        return _switch.execute(TurnOffCommand(light, "Turn off"));
    }
  }
}
